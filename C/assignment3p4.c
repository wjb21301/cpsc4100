...
int main(void) {
    ...
    for (int i = 0; i < length; i++) {
        ...
        else if (currState == 7 && input[i] == '0') {
            nextState = 8;
        }
        else if (currState == 7 && input[i] == '1') {
            nextState = 7;
        }
        else if (currState == 8 && input[i] == '0') {
            nextState = 7;
        }
        else if (currState == 8 && input[i] == '1') {
            nextState = 8;
        }
        currState = nextState;
    }
    if (currState == 0 || currState == 3 || currState == 5 || currState == 6 || currState == 7) {
